...
RUN \
	...
	apk add --no-cache bash py3-lxml py3-xdg@community py3-pyhamcrest@community g++ gcc ffmpeg libmagic deluge@testing boost-python3@main libtorrent-rasterbar@testing && \
