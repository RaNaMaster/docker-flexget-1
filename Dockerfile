...
RUN \
	...
	apk add --no-cache bash py3-lxml py3-xdg@community py3-pyhamcrest@community g++ gcc ffmpeg libmagic deluge boost-python3@main py3-libtorrent-rasterbar@testing && \
